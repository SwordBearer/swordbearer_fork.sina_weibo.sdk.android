...
/**
 * * 此类封装了关系的接口，详情见<a
 * href=http://open.weibo.com/wiki/API%E6%96%87%E6%A1%A3_V2#.E5
 * .85.B3.E7.B3.BB">关系接口</a>
 * 
...
public class FriendshipsAPI extends WeiboAPI {
	...
	public void friends(long uid, int count, int cursor, boolean trim_status,
		...
		request(SERVER_URL_PRIX + "/friends.json", params, HTTPMETHOD_GET,
				listener);
	}
	...
	public void inCommon(long uid, long suid, int count, int page,
		...
		request(SERVER_URL_PRIX + "/friends/in_common.json", params,
	...
	public void bilateral(long uid, int count, int page,
		...
		params.add("count", count);
		params.add("page", page);
		request(SERVER_URL_PRIX + "/friends/bilateral.json", params,
				HTTPMETHOD_GET, listener);
	}
	...
	public void bilateralIds(long uid, int count, int page,
		...
		params.add("count", count);
		params.add("page", page);
		request(SERVER_URL_PRIX + "/friends/bilateral/ids.json", params,
				HTTPMETHOD_GET, listener);
	}
	...
	public void friendsIds(long uid, int count, int cursor,
		...
		params.add("count", count);
		params.add("cursor", cursor);
		request(SERVER_URL_PRIX + "/friends/ids.json", params, HTTPMETHOD_GET,
				listener);
	}
	...
	public void followers(long uid, int count, int cursor, boolean trim_status,
		...
		request(SERVER_URL_PRIX + "/followers.json", params, HTTPMETHOD_GET,
				listener);
	}
	...
	public void followersIds(long uid, int count, int cursor,
		...
		params.add("count", count);
		params.add("cursor", cursor);
		request(SERVER_URL_PRIX + "/followers/ids.json", params,
				HTTPMETHOD_GET, listener);
	}
	...
	public void followersActive(long uid, int count, RequestListener listener) {
		...
		params.add("uid", uid);
		params.add("count", count);
		request(SERVER_URL_PRIX + "/followers/active.json", params,
				HTTPMETHOD_GET, listener);
	}
	...
	public void chainFollowers(long uid, int count, int page,
		...
		params.add("count", count);
		params.add("page", page);
		request(SERVER_URL_PRIX + "/friends_chain/followers.json", params,
				HTTPMETHOD_GET, listener);
	}
